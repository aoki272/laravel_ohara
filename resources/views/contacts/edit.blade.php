                        ...
                        <section class="text-gray-600 body-font relative">
                            <div class="container px-5 py-24 mx-auto">
                                <div class="flex flex-col text-center w-full mb-12">
                                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">お問い合わせ詳細
                                    </h1>
                                </div>
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    ...
                                    <div class="m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" id="gender" name="gender"
                                                    @if ($gender === '男性') checked @endif value="0">男性
                                                <input type="radio" id="gender" name="gender"
                                                    @if ($gender === '女性') checked @endif value="0">女性
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <textarea id="contact" name="contact"
                                                    class="w-full bg-gray-100 bg-opacity-50 roundedborder border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">{{ $contact->contact }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <button type="submit"
                                                class="flex
                                                mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none
                                                hover:bg-indigo-600 rounded text-lg">上書き</button>
                                        </div>
