                    ...
                    <form action="{{ route('contacts.store') }}" method="post">
                        ...
                        <section class="text-gray-600 body-font relative">
                            <div class="container px-5 py-12 mx-auto">
                                ...
                                <div class="lg:w-1/2 md:w-2/3 flex items-center justify-center mx-auto">
                                    <div class="-m-2">
                                        {{-- 名前のインプット --}}
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="name"
                                                    class="leading-7 text-sm text-gray-600">なまえ</label>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" id="gender" name="gender" value="0"
                                                    {{ old('gender') == 0 ? 'checked' : '' }} class="mr-4">男性
                                                <input type="radio" id="gender" name="gender" value="1"
                                                    {{ old('gender') == 1 ? 'checked' : '' }} class="mr-4">女性
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="relative">
